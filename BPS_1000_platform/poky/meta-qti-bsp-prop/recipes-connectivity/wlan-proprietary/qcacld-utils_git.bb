...
DEPENDS_append_sdxhedgehog = " dsutils qmi qmi-framework wpa-supplicant-qcacld libnl qcacld-ll"

RDEPENDS_${PN}_mdm9650 = "wpa-supplicant-qcacld"
RDEPENDS_${PN}_sdxhedgehog = "wpa-supplicant-qcacld"
FILES_${PN} += "${userfsdatadir}/misc/wifi/*"

EXTRA_OECONF = "--with-glib \
                --enable-target=${BASEMACHINE}"
EXTRA_OECONF_append_mdm9650 = " --enable-target-mdm9650=yes --with-qmi-cli --with-qxdm"
EXTRA_OECONF_append_sdxhedgehog = " --with-qmi-cli --with-qxdm"
